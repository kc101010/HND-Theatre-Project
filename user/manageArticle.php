...
//set var user to the current users id, for use in query below
$user = $_SESSION['id'];
...
order by r.id desc');
//this query finds the reviews for the user currently logged on, the user account must be active
...
?>
    ...
    <section id="sect_blog">
        ...
        <?php if ($statement->num_rows == 0): ?>
            <!-- Display this text if no query results -->
